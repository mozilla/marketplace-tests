...
class TestDetailsPage(BaseTest):
    ...
    def test_that_application_page_contains_proper_objects(self, base_url, selenium):
    ...
    def test_that_reports_abuse_as_anonymous_user(self, base_url, selenium):
        home_page = Home(base_url, selenium)
        home_page.go_to_homepage()
        assert home_page.is_the_current_page
    ...
    def test_that_reports_abuse_as_signed_in_user(self, base_url, selenium, new_user):
        home_page = Home(base_url, selenium)
        home_page.go_to_homepage()
        assert home_page.is_the_current_page
    ...
    @pytest.mark.nondestructive
    def test_clicking_on_content_rating(self, base_url, selenium):
        home_page = Home(base_url, selenium)
        home_page.go_to_homepage()
        assert home_page.is_the_current_page
